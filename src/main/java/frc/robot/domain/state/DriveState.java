...
public class DriveState {
    /** 青allianceから正面を見て一番右手前の角を原点(0,0)としたロボットの位置(x[m],y[m])とフィールド上の前向きを0としたロボットの角度[degree]
    ...
    /** 青allianceから正面を見て一番右手前の角を原点(0,0)としたロボットの目標位置(x[m],y[m])とフィールド上の前向きを0としたロボットの目標角度[degree]
