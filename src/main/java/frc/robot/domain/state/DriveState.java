...
public class DriveState {
    /** スタート地点（青allianceから正面を見て一番右手前）を原点(0,0)としたロボットの位置(x[m],y[m])とフィールド上の前向きを0としたロボットの角度[degree]
    ...
    /** スタート地点（青allianceから正面を見て一番右手前）を原点(0,0)としたロボットの目標位置(x[m],y[m])とフィールド上の前向きを0としたロボットの目標角度[degree]
