...
public class BasicDrive implements DriveRepository {
    ...
    public void periodic(){
        ...
        DriveState.targetPosition = new Pose2d(DriveTools.calculateTargetPosition(getPose(),DriveParameter.distanceToShoot),UsecaseUtil.calcurateTargetAngleToShoot(getPose()));
    }
