...
public class FuelSim {
     ...
     */
    public void launchFuel(LinearVelocity launchVelocity, Angle hoodAngle, Angle turretYaw, Translation3d shooterOffset) {
        ...
        Pose3d launchPose = new Pose3d(this.robotPoseSupplier.get())
                .plus(new Transform3d(shooterOffset, Rotation3d.kZero));
