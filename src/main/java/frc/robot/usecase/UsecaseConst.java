...
public class UsecaseConst {
    ...
    public static final class Hubs{
        ...
        /** Hubの中心の座標(blue) */
        public static final Pose2d HubPositionForBlue = new Pose2d(new Translation2d(4.6,4.05),new Rotation2d(0));
    ...
    public static final class Shake{
        ...
        /** Extenderをいい感じに固定する時の角度[degree] */
        public static final double preferredAngle = 25;
