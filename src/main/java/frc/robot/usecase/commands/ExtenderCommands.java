...
public class ExtenderCommands {
    ...
    public static Command shakeExtender(){
        ...
        new SequentialCommandGroup(
            moveExtenderSpecifiedAngle(()->(currentAngle + UsecaseConst.Angles.shakeAngle)).withTimeout(0.5),
            moveExtenderSpecifiedAngle(()->(currentAngle + 5)).withTimeout(1.0).withTimeout(0.5)
        ));
    }
